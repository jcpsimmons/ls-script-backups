  ...
  function() {
    if (window.jQuery) {
      ...
      /*$("#ls_hero_clearance, #ls_hero_event").append(
        '<div class="container ls_hp_container"> <div class="ls_hero_wrapper"> <div class="ls_hero_slider"> <a href="/departments/mattresses/promotions/veteransday"> <img alt="Veterans day event" class="img-responsive" src="/globalassets/images/home/2019/11/revive-veterans-hero-mobile.jpg"> <h1 class="sr-only">Veterans Day Event. Shop all deals. Save up to $800 on the top mattress brands Tempur pedic, revive beautyrest</h1> </a> </div> </div> </div>'
      );
