window.addEventListener(
  ...
  function() {
    if (window.jQuery) {
      ...
      //     '<a href="/departments/mattresses/promotions/veteransday"> <div class="ls_hero_cm"> <img class="img-responsive" alt="Veterans day Event" src="/globalassets/images/home/2019/11/revive-veterans-hero-desktop.jpg"> <p class="sr-only">Veterans Day Event. Shop all deals. Save up to $800 on the top mattress brands Tempur pedic, revive beautyrest</p> </div> </a>'
      // );
