  ...
  function() {
    if (window.jQuery) {
      ...
      $("#ls_hero_clearance, #ls_hero_event").append(
        '<div class="container ls_hp_container"> <div class="ls_hero_wrapper"> <div class="ls_hero_slider"> <a href="/departments/mattresses/promotions"> <img alt="Queen sized bed - king for the price of a queen" class="img-responsive" src="/globalassets/images/home/2019/12/1209_holidaysleep_hp_mobile.jpg"> <h1 class="sr-only">Revive sleep center holiday sleep event - your sweetest dreams are just around the corner.</h1> </a> </div> </div> </div>'
      );
