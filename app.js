  ...
  function() {
    if (window.jQuery) {
      ...
      $("#ls_hero_event").append(
        '<a href="/departments/mattresses/promotions"> <div class="ls_hero_cm"> <img class="img-responsive" alt="Queen sized bed" src="/globalassets/images/home/2019/12/1209_holidaysleep_hp_hero.jpg"> <p class="sr-only">Revive sleep center Holiday Sleep Event. your sweetest dreams are just around the corner. Shop great deals.</p> </div> </a>'
      );
